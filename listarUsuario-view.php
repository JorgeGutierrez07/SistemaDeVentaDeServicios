    ...
    <div class="container-fluid py-3 position-relative d-flex justify-content-between align-items-center">
        ...
        <div class="position-absolute start-50 translate-middle-x">
            <div class="bg-white py-2 px-4 rounded">
                <h1 class="fs-5 text-dark m-0">GESTION DE USUARIO</h1>
            </div>
        </div>
        <div class="px-3">
...
<form id="recuperar-form" method="POST" action="<?php echo APP_URL ?>app/ajax/usuarioAjax.php">
        <h3 class="mb-3">Usuarios Aceptados</h3>
        <?php
                use app\controllers\listUserController;
 
                $insListarUser = new listUserController();
 
                echo $insListarUser->listarControlador(1000);
        ?>
</div>