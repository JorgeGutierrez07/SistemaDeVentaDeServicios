...
<body class="d-flex flex-column vh-100">
    <header class="bg-dark text-white p-3">
		...
		<svg class=" text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button class="btn btn-outline-light btn-lg px-5">Cerrar Sesion</button>
        </div>
    </header>

    <div class="container mt-4 content d-flex justify-content-center align-items-center vh-100">
        <div class="row w-100 h-60">
            <div class="col-12 ">
                <div class="card text-center bg-light h-100">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center h-100">
                        <h2 class="text-primary">¡Bienvenido, Usuario!</h2>
