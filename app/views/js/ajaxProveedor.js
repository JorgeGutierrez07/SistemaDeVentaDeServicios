const formulario_Proveedor = document.querySelectorAll(".FormularioProveedor");

//Alerta para confirmar el envio del fomulario para proveedor
formulario_Proveedor.forEach((formulario_Proveedor) => {
  formulario_Proveedor.addEventListener("submit", function (e) {
    e.preventDefault();
